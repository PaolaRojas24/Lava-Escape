class Player {
  ...
  void display() {
    ...
    if (state <0 && state >=-1){
     PImage leftB;
     leftB = loadImage("pome-left-000.png");
    ...
    //LEFT-1
     ...
     PImage leftB;
     leftB = loadImage("pome-left-001.png");
     image(leftB, x, y-charYShift);
    }
     ...
     //RIGHT-0
      ...
      PImage rightA;
     rightA = loadImage("pome-right-000.png");
    ...
    //RIGHT-1
     ...
     PImage rightB;
     rightB = loadImage("pome-right-001.png");
    ...
    //STILL
     ...
     PImage still;
     still = loadImage("pome-still-000.png");
