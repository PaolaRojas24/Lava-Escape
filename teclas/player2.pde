class Player2 {
  ...
  void display() {
    ...
    if (state <0 && state >=-1){
     PImage leftB;
     leftB = loadImage("terrier-left-000.png");
    ...
    //LEFT1
     ...
     PImage leftB;
     leftB = loadImage("terrier-left-001.png");
     image(leftB, x, y-charYShift);
    }
     ...
     PImage rightA;
     rightA = loadImage("terrier-right-000.png");
    ...
    //RIGHTB
     ...
     PImage rightB;
     rightB = loadImage("terrier-right-001.png");
    ...
    //STILL
     ...
     PImage still;
     still = loadImage("terrier-still-000.png");
